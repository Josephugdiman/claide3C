...
const Contact = () => {
  ...
  Need assistance or have feedback? Send us a quick message below!
</p>
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-gray-500 text-white py-3 rounded-lg font-medium hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-green-500"
            >
              Submit
            </button>
          </form>
