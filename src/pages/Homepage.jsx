...
const Homepage = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="bg-[url('/.')] bg-no-repeat bg-cover  text-black text-center py-52">
      <div className="max-w-screen-lg mx-auto px-6">
          <h1 className="text-5xl font-bold mb-4">
            Welcome to Calbz
            <span className="hover:text-gray-500 text-black">[Shop]</span>
          </h1>
          ...
          <a
            ...
            className="bg-blue-600 text-white py-2 px-6 rounded-lg font-semibold text-lg hover:bg-gray-400 transition duration-300"
          >
            Browse Products
          </a>
        </div>
